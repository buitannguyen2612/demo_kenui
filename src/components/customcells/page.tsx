...
export const BadgeCell = (props: GridCustomCellProps): JSX.Element => {
...
export const BudgetCell = (props: GridCustomCellProps): JSX.Element => {
    const { dataItem } = props;
    ...
    else return <td>No data</td>
};

export const ColumnMenu = (props: GridColumnMenuProps): JSX.Element => {
    return (
        <div>
...
export const PersonCell = (props: GridCustomCellProps): JSX.Element => {
    const { dataItem } = props;
...
export const ProgressCell = (props: GridCustomCellProps): JSX.Element | null => {
...
export const RatingCell = (props: GridCustomCellProps): JSX.Element | null => {
...
export const CountryCell = (props: GridCustomCellProps): JSX.Element | null => {
    const { dataItem } = props;
